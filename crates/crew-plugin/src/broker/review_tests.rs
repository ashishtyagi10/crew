...
// The reviewer is elected by the MODEL (`elect::elect`), with a
// deterministic roster-first fallback — see `elect_tests` for the grammar
// and fallback coverage; the keyword election it replaced is gone.
