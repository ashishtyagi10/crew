...
//! the data behind `/login`'s picker.
//!
...
//! as a popup and send `/login <name>` for the one picked. This is the row,
//! states only — nothing here names or carries a credential.
use serde::{Deserialize, Serialize};

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct SignInOption {
    /// The provider name, as `/login <name>` and `CREW_PROVIDER` spell it.
    pub name: String,
